                ...
                <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-8 lg:grid-cols-10 gap-1.5 md:gap-2">
                  {movie.episodes[selectedServer].items.map((episode) => (
                    <Button
                      ...
                      className={`text-xs md:text-sm h-8 md:h-9 px-1.5 md:px-3 py-0 text-center transition-all ${selectedEpisode?.slug === episode.slug ? 'bg-white text-black hover:bg-white/90' : 'hover:bg-white/10 border-white/10'}`}
